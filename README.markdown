...
This directory contains source files for the Khanty language morphology
...
In order to compile and use Khanty language morphology and dictionaries,
you need:
...
The Khanty language sources can be acquired using [giella SVN
